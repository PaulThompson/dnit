...
import { TrackedFile, file, trackFile, isTrackedFile } from "../core/file/TrackedFile.ts";
import type { TrackedFileHash, Timestamp } from "../interfaces/core/IManifestTypes.ts";
...
Deno.test("TrackedFile - custom hash function", async () => {
  ...
  const customHashFn = (_path: string, _stat: Deno.FileInfo): TrackedFileHash => {
...
Deno.test("TrackedFile - async custom hash function", async () => {
  ...
  const customHashFn = async (_path: string, _stat: Deno.FileInfo): Promise<TrackedFileHash> => {
...
Deno.test("TrackedFile - custom timestamp function", async () => {
  ...
  const customTimestampFn = (_path: string, _stat: Deno.FileInfo): Timestamp => {
...
Deno.test("TrackedFile - async custom timestamp function", async () => {
  ...
  const customTimestampFn = async (_path: string, _stat: Deno.FileInfo): Promise<Timestamp> => {
    return new Promise(resolve => {
...
Deno.test("TrackedFile - getFileData", async () => {
  ...
  const ctx = { manifest } as any; // Mock exec context
...
Deno.test("TrackedFile - task assignment", async () => {
  ...
  const mockTask = { name: "testTask" } as any;
...
Deno.test("TrackedFile - duplicate task assignment throws error", async () => {
  ...
  const mockTask1 = { name: "testTask1" } as any;
  const mockTask2 = { name: "testTask2" } as any;
