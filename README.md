...
```
deno install --allow-read --allow-write --allow-run --unstable -f --name dnit https://deno.land/x/dnit@dnit-v1.14.00/main.ts
```
...
```ts
import {task, main, file} from  "https://deno.land/x/dnit@dnit-v1.14.00/dnit.ts";
