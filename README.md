...
```
deno install --allow-read --allow-write --allow-run --unstable -f --name dnit https://deno.land/x/dnit@dnit-v1.12.6/main.ts
```
...
```
import {task, exec, file} from  "https://deno.land/x/dnit@dnit-v1.12.6/dnit.ts";
